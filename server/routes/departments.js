...
router.put('/:id/add-members/', verifyToken, authorizeUpdateDepartment, addMembers);
router.put('/:id/remove-members/', verifyToken, authorizeUpdateDepartment, removeMembers);
