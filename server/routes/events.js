...
router.put('/:id/enroll-members', verifyToken, authorizeUpdateEvent, enrollMembers);
router.put('/:id/add-participants', verifyToken, authorizeUpdateEvent, addParticipants);
router.put(
...
router.put('/:id/remove-participants', verifyToken, authorizeUpdateEvent, removeParticipants);
